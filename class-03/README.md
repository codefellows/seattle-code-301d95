...
- [Replit: Array filter method](https://replit.com/@sheyna/HighlevelOrderlyAutomatedinformationsystem#index.js)
- [List of Bootstrap classes](https://bootstrapshuffle.com/classes)
